              ...
              <div class="header-social mb-3 d-print-none" data-aos="zoom-in" data-aos-delay="200">
                <nav role="navigation">
                  <ul class="nav justify-content-center">
                    ...
                    <li class="nav-item"><a class="nav-link" href="https://drive.google.com/drive/u/0/folders/1QRO4_XOSF2VJZLyRsly6fnZ1xF8sqQRt" title="Porfolio"><i class="fab fa-google-drive"></i><span class="menu-title sr-only">Portfolio</span></a>
                    </li>
                  </ul>
                </nav>
              </div>
            ...
            <nav role="navigation">
              <ul class="nav justify-content-center">
                <li class="nav-item"><a class="nav-link" href="https://www.linkedin.com/in/connorgreenland/" title="LinkedIn"><i class="fab fa-linkedin"></i><span class="menu-title sr-only">LinkedIn</span></a>
                    ...
                    <li class="nav-item"><a class="nav-link" href="https://drive.google.com/drive/u/0/folders/1QRO4_XOSF2VJZLyRsly6fnZ1xF8sqQRt" title="Portfolio"><i class="fab fa-google-drive"></i><span class="menu-title sr-only">Portfolio</span></a>
                    </li>
              </ul>
            </nav>
          </div>
